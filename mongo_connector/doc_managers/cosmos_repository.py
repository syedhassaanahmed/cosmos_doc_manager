...
class CosmosRepository(object):
    ...
    def create_collection(self, database_id, collection_id, offer_throughput):
        ...
        try:
            self.document_client.CreateCollection(database_link, {"id": collection_id}, {"offerThroughput": offer_throughput})
    ...
    def upsert_documents(self, collection_link, docs):
        ...
        self.document_client.ExecuteStoredProcedure(sproc_link, docs)